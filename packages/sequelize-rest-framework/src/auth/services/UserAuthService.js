...
export class UserAuthService {
    static async registerUser({ models, user }) {
    ...
    static async loginUser({ models, username, password }) {
        const { User, UserCredential, UserSession } = models;
    ...
    static async logoutUser({ models, sessionId }) {
    ...
    static async accessSession({ models, accessToken }) {
        const { UserSession } = models;
    ...
    static async refreshSession({ models, refreshToken }) {
        const { UserSession } = models;
