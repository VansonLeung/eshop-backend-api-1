export const APIGenericMiddlewaresACL = {
    applyMiddlewareACL: ({
        models,
        apiName,
        requiredPermission,
        onDeduceAccessGranted,
    }) => {
        ...
        return async (req, res, next) => {
            try {
                ...
                const isAccessGranted = onDeduceAccessGranted ? (
                    await onDeduceAccessGranted({ req, res, models, apiName, requiredPermission, })
                 ) : true;
